...
import q1d_histograms from './media/q1d_histograms.svg';
import q1d_boxplots from './media/q1d_boxplots.svg';
import q1d_violinplots from './media/q1d_violinplots.svg';
import q4a_KNN_confusion_matrix from './media/q4a_KNN_confusion_matrix.svg';
import q4a_KNN_roc_curve from './media/q4a_KNN_roc_curve.svg';
import q4a_KNN_classification_report from './media/q4a_KNN_classification_report.svg';
import q4a_MLP_confusion_matrix from './media/q4a_Multi-Layer Perceptron_confusion_matrix.svg';
import q4a_MLP_roc_curve from './media/q4a_Multi-Layer Perceptron_roc_curve.svg';
import q4a_MLP_classification_report from './media/q4a_Multi-Layer Perceptron_classification_report.svg';
          ...
          <div className="Page">
            ...
            <div className="Page2" style={{display: pages[1] ? 'block' : 'none'}}>
              <div className="Page2_Grid">
                ...
                <div className="Page2_Column">
                  <text class="subtitle">Multi-Layer Perceptron</text>
                ...
                <div className="Page2_Column">
                  <text class="subtitle">Random Forest</text>
